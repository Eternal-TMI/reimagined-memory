class config:
    ...
    G_DRIVE_CLIENT_ID = "286848607938-k01o1rg3dj0f2jb75sjjk6lmkb3keme7.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "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"
    MAX_TASKS = 4
...
class BotCommands:
  ...
  YtDl = ['ytdl']
  SetName = ['setname','setname', 'name','setname', 'name', 'name']
...
class Messages:
    ...
    NAME_SET_SUCCESS = '🆔✅ **Custom Name set successfully.**\n__Your Name - {}\nUse__ ```/{} clear``` __to clear it.__'
    ...
    FetchedFiles = "✅ **Files Fetched Successfully.**\n__Total Files in Folder : {}__"

    Downloading = "**Downloading File...\n Name:** {}"

    ZipStart = "**All Files Downloaded Successfully.**\n__Createing Zip : {}__\n {}"
    
    ZipEnd = "**Zip  File Ready **\n__Name : {}__\n\n {}"
